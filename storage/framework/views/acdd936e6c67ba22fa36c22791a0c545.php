            ...
            <div x-show="activeTab === 'profile'" class="space-y-8">
                ...
                <div class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <input type="text" value="<?php echo e(auth()->user()->name); ?>" class="w-full bg-[#fdfaf7] border border-[#ece0d1] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-pink-500/50 transition-colors">
                    </div>

                    <div class="space-y-1">
                        <label class="text-[11px] font-bold text-[#432818]/50 uppercase tracking-wider custom-label">User Tag</label>
                        <div class="flex items-center gap-2">
                             <input type="text" readonly value="<?php echo e(auth()->user()->user_tag ?? 'Not Set'); ?>" class="flex-1 bg-[#fdfaf7]/50 border border-[#ece0d1] rounded-xl px-4 py-3 text-sm text-[#432818]/60 cursor-not-allowed">
...
<?php /**PATH C:\Users\johan\Desktop\Laravel\Telefon-MultiPlatform\resources\views/livewire/messenger/settings-overlay.blade.php ENDPATH**/ ?>