    ...
    <div x-show="!isMobile || view === 'list'" 
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div class="flex items-center gap-4 p-4 hover:bg-[#202024] cursor-pointer transition relative group" @click="openChat()">
                <div class="relative w-14 h-14 flex-shrink-0">
                    <img src="https://i.pravatar.cc/150?img=<?php echo e(47+$i); ?>" alt="Avatar" class="w-full h-full rounded-2xl object-cover">
                </div>
                <div class="flex-1 min-w-0 pr-1">
                    <div class="flex justify-between items-baseline mb-1">
                        <h3 class="text-white text-[15px] font-medium truncate">User <?php echo e($i + 1); ?></h3>
